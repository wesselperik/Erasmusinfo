...
public class AppRater {
    ...
    private static final String DEFAULT_TARGET_URI = "market://com.wesselperik.erasmusinfo";
    private static final String DEFAULT_TEXT_TITLE = "Beoordeel deze app";
    private static final String DEFAULT_TEXT_EXPLANATION = "Vindt je deze app nuttig/handig/cool/geweldig? Geef dan je mening op Google Play. Bedankt voor je support!";
    private static final String DEFAULT_TEXT_NOW = "Beoordeel";
