...
/**
 * Created by Wessel on 19-1-2015.
 */
...
public class WVersionManager implements IWVersionManager {
    ...
    public void checkVersion() {
        ...
        if(versionContentUrl == null){
            Log.e(TAG, "http://erasmusinfo.nl/app/versie/new");
            return;
        }
...
// fire request to get update version content
    ...
    */
    ...
    public String getUpdateNowLabel() {
        return updateNowLabel != null? updateNowLabel : "Update nu";
    }
    /* (non-Javadoc)
    ...
    */
    ...
    public String getRemindMeLaterLabel() {
        return remindMeLaterLabel != null? remindMeLaterLabel : "Herinner me later";
    }
    /* (non-Javadoc)
    ...
    */
    ...
    public String getIgnoreThisVersionLabel() {
        return ignoreThisVersionLabel != null? ignoreThisVersionLabel : "Negeer deze versie";
    }
    /* (non-Javadoc)
    ...
    */
    ...
    public String getMessage() {
        ...
        switch(mMode){
            case MODE_CHECK_VERSION:
                defaultMessage = "Wat is er nieuw in deze versie";
                break;
            case MODE_ASK_FOR_RATE:
    ...
    */
    ...
    public String getTitle() {
        ...
        switch(mMode){
            case MODE_CHECK_VERSION:
                defaultTitle = "Nieuwe update beschikbaar";
                break;
            case MODE_ASK_FOR_RATE:
    ...
    */
    ...
    private String getGooglePlayStoreUrl(){
        ...
        return "http://erasmusinfo.nl/app/";
    }
